object Versions {
    ...
    const val COMPOSE_VERSION = "1.8.0-alpha07"
    const val CONSTRAINT_LAYOUT_COMPOSE_VERSION = "1.1.0"
    const val COMPOSE_ACTIVITY_VERSION = "1.10.0-rc01"
    const val COMPOSE_MATERIAL_YOU_VERSION = "1.4.0-alpha05"
    const val COMPOSE_ICONS_VERSION = "1.7.6"
    const val LIVE_DATA_VIEW_MODEL_VERSION = "2.9.0-alpha08"
    const val PLAY_SERVICES_MAPS_VERSION = "19.0.0"
    const val PLAY_SERVICES_LOCATION_VERSION = "21.3.0"
    const val MATERIAL_VERSION = "1.13.0-alpha09"
    const val APP_COMPAT_VERSION = "1.7.0"
    const val LOTTIE_COMPOSE_VERSION = "6.6.2"
    const val BROWSER_VERSION = "1.8.0"
    const val DATA_STORE_PREFERENCE_VERSION = "1.1.1"
    const val GOOGLE_MAPS_COMPOSE_VERSION = "6.4.0"
    ...
    const val LIFECYCLE_RUNTIME_KTX_VERSION = "2.9.0-alpha08"
