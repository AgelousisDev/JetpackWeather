object Versions {
    ...
    const val navVersion = "2.7.2"
    const val composeVersion = "1.6.0-alpha05"
    const val constraintLayoutVersion = "2.1.3"
    const val constraintLayoutComposeVersion = "1.1.0-alpha12"
    const val composeActivityVersion = "1.8.0-beta01"
    const val composeMaterialYouVersion = "1.2.0-alpha07"
    const val liveDataViewModelVersion = "2.7.0-alpha02"
    ...
    const val browserVersion = "1.6.0-rc01"
    const val dataStorePreferenceVersion = "1.0.0"
    const val googleMapsComposeVersion = "2.8.1"
    ...
    const val lifecycleRuntimeKtxVersion = "2.7.0-alpha02"
