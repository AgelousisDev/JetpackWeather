object Versions {
    ...
    const val composeActivityVersion = "1.8.1"
    const val composeMaterialYouVersion = "1.2.0-alpha11"
    ...
    const val lottieComposeVersion = "6.2.0"
    const val browserVersion = "1.8.0-alpha01"
    const val dataStorePreferenceVersion = "1.0.0"
    const val googleMapsComposeVersion = "4.3.0"
    ...
    const val http3LoggingInterceptorVersion = "5.0.0-alpha.11"
