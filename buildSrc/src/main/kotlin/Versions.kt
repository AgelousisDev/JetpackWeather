object Versions {
    ...
    const val composeMaterialYouVersion = "1.2.0-alpha10"
    const val liveDataViewModelVersion = "2.7.0-alpha03"
    ...
    const val browserVersion = "1.7.0-beta01"
    const val dataStorePreferenceVersion = "1.0.0"
    const val googleMapsComposeVersion = "4.1.1"
    ...
    const val lifecycleRuntimeKtxVersion = "2.7.0-alpha03"
    ...
    const val githubBanesVersion = "0.49.0"
}
object ConfigData {
