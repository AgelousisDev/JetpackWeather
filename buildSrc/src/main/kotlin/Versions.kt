object Versions {
    ...
    const val coreKtxVersion = "1.12.0-alpha05"
    const val navVersion = "2.7.0-beta02"
    const val composeVersion = "1.6.0-alpha01"
    ...
    const val composeMaterialYouVersion = "1.2.0-alpha03"
    const val liveDataViewModelVersion = "2.6.1"
    ...
    const val lottieComposeVersion = "6.0.1"
    const val browserVersion = "1.6.0-beta01"
