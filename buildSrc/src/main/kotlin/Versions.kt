object Versions {
    ...
    const val KOTLIN_VERSION = "2.1.0-Beta2"
    const val CORE_KTX_VERSION = "1.15.0-rc01"
    const val NAVIGATION_VERSION = "2.9.0-alpha01"
    const val COMPOSE_VERSION = "1.8.0-alpha04"
    const val CONSTRAINT_LAYOUT_COMPOSE_VERSION = "1.1.0-rc01"
    const val COMPOSE_ACTIVITY_VERSION = "1.10.0-alpha02"
    const val COMPOSE_MATERIAL_YOU_VERSION = "1.4.0-alpha02"
    const val COMPOSE_ICONS_VERSION = "1.7.4"
    const val LIVE_DATA_VIEW_MODEL_VERSION = "2.9.0-alpha05"
    ...
    const val LIFECYCLE_RUNTIME_KTX_VERSION = "2.9.0-alpha05"
    const val LIFECYCLE_EXTENSION_VERSION = "2.2.0"
    const val JUNIT_VERSION = "4.13.2"
    const val TEST_EXT_JUNIT_VERSION = "1.2.1"
    const val TEST_ESPRESSO_CORE_VERSION = "3.6.1"
