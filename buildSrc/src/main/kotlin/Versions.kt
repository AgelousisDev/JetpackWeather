object Versions {
    ...
    const val coreKtxVersion = "1.12.0-alpha04"
    const val navVersion = "2.7.0-alpha01"
    const val composeVersion = "1.5.0-beta01"
    const val constraintLayoutVersion = "2.1.3"
    const val constraintLayoutComposeVersion = "1.1.0-alpha10"
    const val composeActivityVersion = "1.8.0-alpha04"
    const val composeMaterialYouVersion = "1.2.0-alpha02"
    ...
    const val browserVersion = "1.6.0-alpha01"
...
object ConfigData {
    const val compileSdkVersion = "UpsideDownCake"
    const val minSdkVersion = 27
    const val targetSdkVersion = "UpsideDownCake"
