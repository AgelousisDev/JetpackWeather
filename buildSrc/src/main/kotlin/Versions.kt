object Versions {
    ...
    const val COMPOSE_VERSION = "1.8.0-alpha08"
    const val CONSTRAINT_LAYOUT_COMPOSE_VERSION = "1.1.0"
    const val COMPOSE_ACTIVITY_VERSION = "1.10.0"
    const val COMPOSE_MATERIAL_YOU_VERSION = "1.4.0-alpha06"
    ...
    const val MATERIAL_VERSION = "1.13.0-alpha10"
    const val APP_COMPAT_VERSION = "1.7.0"
    const val LOTTIE_COMPOSE_VERSION = "6.6.2"
    const val BROWSER_VERSION = "1.8.0"
    const val DATA_STORE_PREFERENCE_VERSION = "1.1.2"
    const val GOOGLE_MAPS_COMPOSE_VERSION = "6.4.1"
